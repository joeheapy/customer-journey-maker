...
import { BusinessPainPointData } from "@/lib/types";
...
// This function checks if the provided data is a valid business pain point
function isPainPoint(point: unknown): point is BusinessPainPointData {
  ...
  const validations = Array.from(
    ...
    (i) =>
      `business-pain-${i}` in point &&
      typeof point[`business-pain-${i}`] === "string"
  );
        ...
        tools: [
          {
            ...
            function: {
              ...
              description: "Create business pain points per journey step",
              parameters: {
                type: "object",
                properties: {
                  painPoints: {
